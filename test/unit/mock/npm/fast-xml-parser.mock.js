...
exports.createMock = function createMock() {
	...
	td.when(fastXmlParser.XMLBuilder.prototype.build(), { ignoreExtraArgs: true }).thenReturn(
		'mock-build-xml'
	);

	fastXmlParser.XMLParser.prototype.parse = td.func();
	td.when(fastXmlParser.XMLParser.prototype.parse(), { ignoreExtraArgs: true }).thenReturn(
		'mock-parsed-xml'
	);
