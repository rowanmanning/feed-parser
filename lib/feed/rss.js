...
class RssFeed extends Feed {
	...
	get version() {
		...
		if (version && RssFeed.ALLOWED_VERSIONS.includes(version)) {
			return version;
		}
		if (version && version.startsWith(RssFeed.VERSION_0_9)) {
			return RssFeed.VERSION_0_9;
		}
		if (
 ...
 * @type {string}
 */
RssFeed.VERSION_0_9 = '0.9';

/**
 * @type {RegExp}
 */
RssFeed.VERSION_MATCHER_0_9 = /^0.9\d$/;

/**
 * @type {string}
 */
RssFeed.VERSION_1_0 = '1.0';

/**
 * @type {string}
 */
RssFeed.VERSION_2_0 = '2.0';

/**
 * @type {Array<string>}
 */
RssFeed.ALLOWED_VERSIONS = [
	RssFeed.VERSION_0_9,
	RssFeed.VERSION_1_0,
	RssFeed.VERSION_2_0
];
