 ...
 */
function parseContactString(authorString) {
	...
	const email = words.find(({ isEmail }) => isEmail)?.text || null;
	const url = words.find(({ isUrl }) => isUrl)?.text || null;
...
exports.parseContactString = parseContactString;
